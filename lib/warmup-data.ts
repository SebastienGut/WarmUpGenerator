...
const rawExercises: Exercise[] = [
  ...
  },
  {
    ...
    name: "Y-raise et élévations légères",
    category: "activation",
    muscles: ["epaules"],
    objectives: ["force", "hypertrophie", "reprise"],
    contraindications: ["epaule"],
    durationSeconds: 30,
    equipment: "haltere",
    description: "Haltères très légers. Alternez une élévation en Y devant vous puis une élévation latérale, sans dépasser la hauteur d'épaule. Mouvement lent, propre, sans chercher la brûlure.",
    reps: "6 Y + 6 latérales",
    fallback: "Même enchaînement sans charge : bras tendus, pause 2s en haut de chaque élévation.",
  },
